...
**build-fix** is open source and free to use. It's one of the developer tools we built while helping teams ship AI-generated apps to production.

AI code generators produce apps fast, but build errors slow down deployment. We built build-fix to automatically patch common TypeScript errors so our customers' apps ship without delay.
